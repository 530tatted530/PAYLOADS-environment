...
[![Elastic Stack version](https://img.shields.io/badge/ELK-6.8.12-blue.svg?style=flat)](https://github.com/deviantony/docker-elk/issues/540)
...
To use a different version of the core Elastic components, simply change the version numbers inside the `.env` file. If
